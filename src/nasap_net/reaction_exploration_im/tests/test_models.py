...
def test_binding_site_ordering_in_bond():
    bond1 = Bond(comp_id1="L1", comp_id2="M1", site1="a", site2="b")
    bond2 = Bond(comp_id1="M1", comp_id2="L1", site1="b", site2="a")
    assert bond1 == bond2
...
def test_bond_same_site_error():
    with pytest.raises(ValueError):
        Bond(comp_id1="M1", comp_id2="M1", site1="a", site2="b")
    # Should not raise
    Bond(comp_id1="M1", comp_id2="M2", site1="a", site2="a")
...
def test_assembly():
    ...
    assembly = Assembly(
        ...
        bonds={Bond(comp_id1="L1", comp_id2="M1", site1="a", site2="a")}
        )
    assert assembly.components == {"L1": L, "M1": M}
    assert assembly.bonds == frozenset({
        Bond(comp_id1="L1", comp_id2="M1", site1="a", site2="a")})
